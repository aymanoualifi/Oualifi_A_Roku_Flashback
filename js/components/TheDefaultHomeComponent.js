export default {
  ...
  <li v-for="movie in activeTab === 'movies' ? movieList : seriesList" :key="movie.id" class="movie-card" @click="showMovieDetails(movie.id)">
    ...
    created() {
        ...
        const movieApiUrl = `https://imdb-api.com/API/AdvancedSearch/k_85pgs5gt?title_type=movie&release_date=1950-01-01,1959-01-01`;
        const seriesApiUrl = `https://imdb-api.com/API/AdvancedSearch/k_85pgs5gt?title_type=tv_series&release_date=1950-01-01,1959-01-01`;
